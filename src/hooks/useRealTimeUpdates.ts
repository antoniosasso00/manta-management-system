...
export function useDashboardKPI() {
  ...
  const fetchKPIDataRef = useRef<(() => Promise<void>) | undefined>(undefined)
...
export function useAuditEvents() {
  ...
  const fetchAuditDataRef = useRef<(() => Promise<void>) | undefined>(undefined)
...
export function useUserStats() {
  ...
  const [loading, setLoading] = useState(true)
  const [error, setError] = useState<string | null>(null)
  const fetchStatsDataRef = useRef<(() => Promise<void>) | undefined>(undefined)
